...
@synthesize enableDebug, cameraPrivacy, microphonePrivacy, experimentalOptions, hideConfig, autoJoin, allowReconnect, returnURL, vidyoCloudJoin, portal, encryptedData;
...
-(void) extractDefaultParameters {
    ...
    encryptedData       = [standardUserDefaults  stringForKey:@"encryptedData"];
...
-(void) extractURLParameters:(NSMutableDictionary *)urlParameters {
    ...
    encryptedData       = [urlParameters  objectForKey:@"encryptedData"];
